...
public class DiskLruCacheManager {
    ...
    public void deleteFile(Context context, String dirName) {
        try {
            Util.deleteContents(packDiskCacheFile(context, dirName));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
